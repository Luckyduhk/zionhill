<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {{ $attributes }}>
  ...
  <g id="SVGRepo_iconCarrier">
    ...
    <path d="M7 7L11 7" stroke="#222222" stroke-width="1.2" stroke-linecap="round"></path>
    <path d="M8 11H7" stroke="#222222" stroke-width="1.2" stroke-linecap="round"></path>
    <path d="M7 15L10 15" stroke="#222222" stroke-width="1.2" stroke-linecap="round"></path>
  </g>
</svg>

  ...
  <form method="post" action="{{ route('members.store') }}" enctype="multipart/form-data">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
      ...
      <div>
        ...
        <x-text-input id="phone" name="phone" type="text" :value="old('phone')" required autocomplete="phone"
          maxlength="255" />
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
      ...
      <div>
        ...
        <x-text-input id="last_visited_date" name="last_visited_date" type="date" :value="old('last_visited_date')" required
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
      <div>
        ...
        <x-select-input id="clothing_size" name="clothing_size" type="text" :options="$clothingSizes"
          chooseOptionText="Select a Clothing Size" :selectedOption="old('clothing_size')" required autocomplete="clothing_size" />
        <x-input-error :messages="$errors->get('clothing_size')" />
      </div>
      <div x-data="imageViewer(@js(asset('images/no-user.png')))">
        <x-input-label for="picture" :value="__('Picture')" required="true" />
